...
export default function ExpandedSideBar(props) {
  return (
    <div className="w-[400px] shadow-xl absolute left-full top-0 z-10 h-full bg-slate-600 max-md:h-auto max-md:static max-md:w-full max-md:py-6 max-md:mx-auto">
